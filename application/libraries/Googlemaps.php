...
class Googlemaps {
	...
	var $center						= "-7.9784695, 112.5617413, 12";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
