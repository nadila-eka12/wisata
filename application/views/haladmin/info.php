...
<head>
    ...
    <title>Info</title>
    <script>
        function edit_info_popup(info_id) {
            //alert(lokasi_id);


            $.ajax({
                url: "<?php echo base_url('index.php/data_info/editinfo/'); ?>",
                type: 'POST',
                data: {
                    info_id: info_id
                },
...
<body>
    ...
    <div class="container">
                            ...
                            <table id="example1" align="center" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <div align="center"><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal" data-toggle="tooltip" data-placement="top" title="Tambah">Tambah</div></button>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    ?>
                                            ...
                                            <td>
                                                ...
                                                <td>
                                                    <div align="center"><img src="<?php echo base_url('uploads/' . $row->gambar) ?>" width="200px" height="150px"></div>
                                                </td>
                                                <td>
                                                    <div align="center"><?php echo $row->judul; ?></div>
                                                </td>
                                                <td>
                                                    <div align="center"><?php echo $row->isi; ?></div>
                                                </td>
                                                <td>
                                                    <div align="center"><?php echo $row->tanggal; ?></div>
                                                </td>
                                                <td class="center">
                                                    <div align="center">
                                                    <a onclick="edit_info_popup(<?php echo $row->id; ?>);" type="button" class="btn btn-warning btn-circle" data-toggle="tooltip" data-placement="top" title="Edit">Edit<i class="fa fa-edit"></i></a>
                                                        <a class="btn btn-danger btn-circle" data-toggle="tooltip" data-placement="top" title="Delete" href="<?php echo site_url('data_info/hapus/' . $row->id) ?>" onclick="return confirm('Anda Yakin ?');">Hapus<i class="fa fa-times"></i>
                                                        </a>
                                                    </div>
                                                </td>
                                            </tr>
        ...
        <?php echo form_open_multipart('data_info/tambah') ?>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="box-body pad">
                                <textarea id="judul" name="judul" class="form_control" type="text" rows="1" cols="73" required></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Isi</label>
                            <div class="box-body pad">
                                <textarea id="isi" name="isi" class="form_control" type="text" rows="1" cols="73" required></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Tanggal</label>
