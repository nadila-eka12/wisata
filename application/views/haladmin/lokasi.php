                            ...
                            <table id="example1" align="center" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <div align="center">Informasi</div>
                                        </th>
                                        <th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div align="center"><?php echo $row->nama_lokasi; ?></div>
                                                </td>
                                                <td>
                                                    <div align="center"><?php echo $row->garis_lintang; ?></div>
                                                </td>
                                                <td>
                                                    <div align="center"><?php echo $row->garis_bujur; ?></div>
                                                </td>
                                                <td>
                                                    <div align="center"><?php echo $row->informasi; ?></div>
                                                </td>
                                                <td>
                                                ...
                                                <td class="center">
                                                    <div align="center">
                                                        <a onclick="edit_lokasi_popup(<?php echo $row->id_lokasi; ?>);" type="button" class="btn btn-warning btn-circle" data-toggle="tooltip" data-placement="top" title="Edit">Edit<i class="fa fa-edit"></i></a>
                                                        <a class="btn btn-danger btn-circle" data-toggle="tooltip" data-placement="top" title="Delete" href="<?php echo site_url('data_lokasi/hapus/' . $row->id_lokasi) ?>" onclick="return confirm('Anda Yakin ?');">Hapus<i class="fa fa-times"></i>
                                                        </a>
                                                    </div>
                                                </td>
                                            </tr>
